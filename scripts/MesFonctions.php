...
echo "	<tr>";
echo "      <td align='center' height='3' valign='bottom' bgcolor='#660033'><font color='#ffffff' face='Arial, Helvetica, sans-serif' size='-2'></font></td>";
echo "    </tr>";
echo "	<tr>";
echo "		<td align='center' valign='top' width='850' height='20' background='./images/bottom.gif'><font color='#D3C1D5' face='Arial, Helvetica, sans-serif' size='-2'><em><a href='http://www.tela-botanica.org/papyrus.php?site=2&menu=104' style='color:#D3C1D5;text-decoration:none;' target='_blank'>Licence Creative Commons by-sa</a> - 2005 Legumino - Réalisé par Grégory BOCK </em></font></td>";
echo "	</tr>";
echo "</table>";
echo "</BODY>";
echo "</HTML>";
...
echo "<HEAD><title>Legumino</title>\r";
echo "<META NAME=\"DESCRIPTION\" CONTENT=\"Actualisation de la cartographie des Légumineuses en France\">\r";
echo "<META NAME=\"KEYWORDS\" CONTENT=\"Photoflora, photoflora, legumino, Legumino, Leguminosae, leguminosae, carte, cartographie, actualisation, france, Fabaceae, Légumineuses, légumineuses, legumineuses, Légumino, légumino\">\r";
...
echo "BODY {\r";
echo "scrollbar-face-color: #660033; \r";
echo "scrollbar-arrow-color: #FFFFFF; \r";
echo "}";

echo "TABLE.border {\r";
echo "        border:1px #660033 solid; \r";
echo "}\r";

echo "A.type1:link {color:#33662B; text-decoration:none;}\r";
echo "A.type1:visited {color:#33662B; text-decoration:none;}\r";
echo "A.type1:active {color:#33662B; text-decoration:none;}\r";
echo "A.type1:hover {color:#33662B; text-decoration:underline;}\r";
...
echo "	}\r";
echo ".menua:hover {color:#FF9BA3;}\r";
echo "</style>\r";
...
echo "<table class='border' cellpadding='0' cellspacing='0' width='850' bgcolor='#660033' align='center'>";
echo "<tr>";
...
echo "<table class='border' width='850' bgcolor='#FFFFB9' cellpadding='0' cellspacing='0' align='center'>";
