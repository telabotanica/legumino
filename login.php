...
if (isset($_SESSION["authentification2"])){ // vérification sur la session authentification2 (la session est elle enregistrée ?)
		...
		// GESTION DE LA Déconnexion
				...
				session_unset("authentification2");
				}
}
				...
				$verif_query=sprintf("SELECT id_contributeurs, login, pass, privilege FROM contributeurs WHERE login='$login' AND pass='$pass'"); // requête sur la base administrateurs
				...
				$utilisateur = mysql_num_rows($verif);
					...
					if ($utilisateur == 1) {	// On test s'il y a un utilisateur correspondant
						$_SESSION["authentification2"] = array('codeencarton'); // enregistrement de la session
...
<form action="" method="post" name="connect">
  ...
  <p align="center"><b><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><em>Cette rubrique nécessite une identification,<br>Veuillez vous identifier : </em></font></b></p>
  

    <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" align="center">
      <tr>
        <td colspan="2"><table width="400"  border="0" cellpadding="10" cellspacing="0" bgcolor="#E7D8E7">
          <tr>
            <td width="50%"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b>LOGIN </b></font></td>
            <td width="50%"><input name="login" type="text" id="login"></td>
          </tr>
          <tr>
            <td width="50%"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b>MOT DE PASSE </b></font></td>
	  ...
	  <tr>
		     <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><em><a href="./inscription.php">S'inscrire</a></em></font></td>
             <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><em><a href="./envoi.php">J'ai oublié mon mot de passe...</a></em></font></td>
 		  </tr>
	</table>
