...
$sql_nb = "SELECT count(*) FROM legumino, contributions, contributeurs, communes, departements 
WHERE communes.num_departements = departements.num_departements and legumino.NumTaxon = contributions.NumTaxon
and communes.code_insee = contributions.code_insee
and contributeurs.id_contributeurs = contributions.id_contributeurs
and legumino.Famille like '$Famille' and legumino.Genre like '$Genre' and legumino.Espece like '$Espece' and legumino.Rang <= '$Rang' and 
legumino.LivreRouge like '$LivreRouge' and legumino.Hybride like '$Hybride' and legumino.NumTaxon like '$NumTaxon' and contributions.date_saisie >= '$date_saisie' and communes.num_departements like '$dep' and communes.code_insee like '$Commune' and contributeurs.id_contributeurs like '$Contributeur'";
...
mysql_select_db($database_PF, $PF);
$query_Trouve = "SELECT * FROM legumino, contributions, contributeurs, communes, departements 
WHERE communes.num_departements = departements.num_departements and legumino.NumTaxon = contributions.NumTaxon
and communes.code_insee = contributions.code_insee
and contributeurs.id_contributeurs = contributions.id_contributeurs
and legumino.Famille like '$Famille' and legumino.Genre like '$Genre' and legumino.Espece like '$Espece' and legumino.Rang <= '$Rang' and 
legumino.LivreRouge like '$LivreRouge' and legumino.Hybride like '$Hybride' and legumino.NumTaxon like '$NumTaxon' and contributions.date_saisie >= '$date_saisie' and communes.num_departements like '$dep' and communes.code_insee like '$Commune' and contributeurs.id_contributeurs like '$Contributeur'  
ORDER BY legumino.Genre, legumino.Espece, legumino.SousEspece, legumino.Infra2, legumino.Infra3, communes.num_departements, communes.nom_communes
...
{ ?>
			...
			<p align="center"><font color="#33662B" face="Arial, Helvetica, sans-serif"><b>Aucune observation ne r&eacute;pond 
			  &agrave; votre recherche</b></font></p>
			<font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">
...
?>
				...
				<tr> 
					...
					<? if (isset($_SESSION["authentification2"])) {}
								else { echo "<br>"; } ?>
					<font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><?php if ($nb_messages=="1") {echo ("Seule observation r&eacute;pondant &agrave; votre recherche : ");} else {echo "Les ".$nb_messages." observations suivantes r&eacute;pondent &agrave; votre recherche : ";}?></font><br><br></td>
					<td width="50"></td>
					<td width="30"></td>
				</tr>
				<? } else { 
				...
				<table width="750" border="0" cellpadding="0" cellspacing="0" align="center">
				  <tr> 
					...
					<td width="14%" align="center" valign="top"> 
					  <p><font face="Arial, Helvetica, sans-serif" size="-1" color="#660033">
...
<? //****************************************************** affichage des résultats ******************************************				
				...
				<tr>
					<td width="50"></td>
					<td width="600" align="left"><font color="#660033" face="Arial, Helvetica, sans-serif" size="-1">
					...
					<? 
					   if ($w != 1) 
						{
						?>
						<form name="carte" method="post" action="UneLegumino.php" style="display:inline">
				...
				<tr>
					<td></td>
					<td width="600" align="left"><br><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">
				...
				<tr>
					<td width="50"></td>
					<td width="600" align="left"><b><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">
				...
				<tr>
					<td></td>
					<td align="left"><font color="#660033" face="Arial, Helvetica, sans-serif" size="-1">
					<? calccombinaison($row_Trouve['Rang'],$row_Trouve['Genre'],$row_Trouve['Espece'],$row_Trouve['Auteur'],$row_Trouve['TypeSousEspece'],$row_Trouve['SousEspece'],$row_Trouve['AuteurSousEspece'],$row_Trouve['TypeInfra2'],$row_Trouve['Infra2'],$row_Trouve['AuteurInfra2'],$row_Trouve['TypeInfra3'],$row_Trouve['Infra3'],$row_Trouve['AuteurInfra3']);?>
