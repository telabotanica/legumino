...
$query_Trouve = "SELECT * FROM legumino where NumTaxon = '$NumTaxonPterido'";
...
?>
<style>
A.type1:link {color:#33662B; text-decoration:none;}
A.type1:visited {color:#33662B; text-decoration:none;}
A.type1:active {color:#33662B; text-decoration:none;}
A.type1:hover {color:#33662B; text-decoration:underline;}
</style>
<br>
<table width="750" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					<td></td>
					<td align="center" height="30"><font color="#660033" face="Arial, Helvetica, sans-serif" size="-1">
				...
				<tr>
					<td></td>
					<td align="left"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">
					<br><u>Répartition géographique</u> : </font>
					<font color="#33662B" face="Arial, Helvetica, sans-serif" size="-2">Cliquez sur le n° du département pour voir les observations de ce taxon.</font>
					<br><br>
					</td>
					<td></td>
				</tr>
				...
				<tr>
					...
					<td align="center">
												...
												<tr> 
												  ...
												  <td width="30" height="3"></td>
												  <td width="30" height="3"></td>
												  <td width="160" rowspan="3" align="center" valign="middle"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">&nbsp;Nombres 
													d'observations </font></td>
												</tr>
												<tr> 
												  <td width="20" height="3" bgcolor="#fec4c4"></td>
												  <td width="20" height="3" bgcolor="#de689f"></td>
												  <td width="20" height="3" bgcolor="#993366"></td>
												</tr>
												<tr> 
												  <td width="20" height="3"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-2">0</font></td>
												  <td width="20" height="3"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-2">5</font></td>
												  <td width="20" height="3"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-2">15</font></td>
												</tr>
											  </table>
					</td>
					<td width="50"></td>
					...
					<td align="center">
											<table border="0" cellpadding="0" cellspacing="0">
												<tr> 
												  ...
												  <td><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Commune où le taxon est présent<br></font></td>
												</tr>
											  </table>
