...
mysql_select_db($database_PF, $PF);
$query_RechercherNumTaxon2 = "SELECT * FROM legumino where NumTaxon = '$NumTaxonContrib' ";
...
<tr>
      	...
      	<td colspan="2" valign="top" align="left"><img src="./images/fleche.jpg"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b><u>MODIFICATION DE LA CONTRIBUTION</u></b></font></td>
...
<tr>
	   <td width="50"></td>
       <td width="150" align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Date* : </font></td>
       <td width="500">
...
<tr>
			 ...
			 <select name="NumTaxonContrib" size="1" id="NumTaxonContrib">
...
<tr> 
	 <td></td>
     <td align="right" valign="top"><p><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Commentaires :</font></p></td>
	 <td align="left">
	 <? 
