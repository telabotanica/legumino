...
<tr>
      	...
      	<td valign="top" align="left" colspan="2"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b><u>Envoyer un message à <? echo $row_Dest['prenom_contributeurs']." ".$row_Dest['nom_contributeurs'];?></u> : </b></font></td>
     	 
		 <td width="50"></td>
    </tr>
<!-- ici le début du formulaire -->
<form method="post" name="formenvoi" id="formenvoi" action="">
<tr>
			 <td width="50"></td> 
     		 <td align="right" width="200"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Sujet :</font>
...
<tr>
			 <td></td> 
     		 <td valign="top" align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Votre message :</font>
...
<tr>
	...
	<input type="button" name="valider" value="Envoyer le message" onclick="envoi();"></td>
	<td></td>
</tr>
</form>
