...
if (isset($_SESSION["authentification2"])){ // vérification sur la session authentification2 (la session est elle enregistrée ?)
...
if (isset($NumTaxon))  {
			...
			/*
			//verification pour eviter doublon (l'observation a-t-elle deja ete faite?)
			mysql_select_db($database_PF, $PF);
			$query_doublon = "SELECT NumTaxon, code_insee, id_contributeurs FROM contributions WHERE NumTaxon = '$NumTaxon' and code_insee = '$Commune' and id_contributeurs = '$id_session' ";
...
<tr>
		...
		<? if (isset($NumTaxon)) {?><em><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b><u>AUTRE AJOUT</u></b></font></em><? } //titre 
		else {?>
		<em><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b><u>AJOUTER UNE OBSERVATION</u></b></font></em>
     	 <? } ?>
		 </td>
		 <td width="50"></td>
    </tr>
<tr>
	   <td width="50"></td>
       <td width="150" align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Date d'observation* : </font></td>
       <td width="500">
...
<tr>
			 <td></td> 
     		 <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Taxon observé* :</font></td>
    		 <td><select name="NumTaxon" size="1" id="NumTaxon">
        	  <option value="">-</option>	  
          <?php
do {  
?>
...
<tr> 
	 <td></td>
     <td align="right" valign="top"><p><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Echantillon :</font></p></td>
	 <td align="left">
...
<tr> 
	 <td></td>
     <td align="right" valign="top"><p><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Commentaire :</font></p></td>
...
<tr>
	<td></td>
	<td colspan="2" align="justify"><br><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">* <em>Champs obligatoires</em></font><br><br></td>
...
mysql_free_result($RechercherDepartement2); 
