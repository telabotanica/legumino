...
mysql_select_db($database_PF, $PF);
$query_RechercherNumTaxon = "SELECT * FROM legumino ORDER BY Genre, Espece, SousEspece";
...
<table width="750" align="center">
	<tr>
      	...
      	<td valign="middle" align="left" colspan="2"><img src="./images/fleche.jpg"><em><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b><u>
		<? if ($w == 1) {
	...
	<tr>
			 <td></td> 
     		 <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Taxon :</font></td>
    		 <td><select name="NumTaxon" size="1" id="NumTaxon" onchange="this.style.color = this.options[selectedIndex].style.color;">
        	  <option value="" style="color:#999999;">-- Indifférent --</option>	  
						  <?php
				do {  
				?>
						  <option value="<?php echo $row_RechercherNumTaxon['NumTaxon']?>" style="color:#000000;"><? echo $row_RechercherNumTaxon['Genre']." ".$row_RechercherNumTaxon['Espece']." ".$row_RechercherNumTaxon['TypeSousEspece']." ".$row_RechercherNumTaxon['SousEspece']." ".$row_RechercherNumTaxon['TypeInfra2']." ".$row_RechercherNumTaxon['Infra2']." ".$row_RechercherNumTaxon['TypeInfra3'],$row_RechercherNumTaxon['Infra3'];?></option>
						  <?php
	...
	<tr>
	  <td width="50"></td> 
      <td height="30"></td>
      <td><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">&nbsp;</font></td>
	  <td width="50"></td>
    </tr>	
    
    <tr>
	  <td width="50"></td> 
      <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Genre :</font></td>
      <td><input name="Genre" type="text" id="Genre" value="-- Indifférent --" onFocus="effaceGenre()"></td>
	  <td width="50"></td>
    </tr>
    <tr>
	  <td width="50"></td> 
      <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Esp&egrave;ce :</font></td>
      <td><input name="Espece" type="text" id="Espece" value="-- Indifférent --" onFocus="effaceEspece()"></td>
	  <td width="50"></td>
    </tr>
    <tr>
	  <td width="50"></td> 
      <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Rang : </font></td>
    ...
    <tr>
	  <td width="50"></td> 
      <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Livre rouge :</font></td>
    ...
    <tr>
	  <td width="50"></td> 
      <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Hybride : </font></td>
   ...
   <tr>
	  <td width="50"></td> 
      <td height="30"></td>
      <td><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-2">&nbsp;</font></td>
	  <td width="50"></td>
    </tr>
   
   <tr>
			 <td width="50"></td> 
     		 <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Contributeur :</font></td>
...
<tr>
			 <td width="50"></td> 
     		 <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Département :</font></td>
...
?>
	...
	<tr>
			 <td width="50"></td> 
     		 <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Commune :</font></td>
			 <td>
			 <iframe id="imenu" vspace="0" hspace="0" marginwidth="0" marginheight="0" name="imenu" height="22" width="390" style="background-color:#FFFFB9" frameborder="0" scrolling="no" src="./imenu.php?type=<? echo $type;?>"></iframe></td> 
		<td width="50"></td>
    </tr>
	
	<tr>
	  <td width="50"></td> 
      <td align="right"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Ajoutées depuis le : </font></td>
      <td>
	...
	<tr>
	 ...
	 <tr>
	  ...
	  <input type="hidden" name="Famille" id="Famille" value="%">
