...
if (isset($login))  {
			...
			$msg .= $password."\n";
			$msg .= "****************************************************\n\n";
			$msg .= "Rendez-vous sur : https://legumino.tela-botanica.org/ \n";
			$msg .= "\n\n\n Bien cordialement,";
			
			$subject = "Votre mot de passe pour le site web LEGUMINO";
			
			$mailheaders = "From: legumino3@free.fr";
...
<tr>
      	...
      	<td width="250" valign="top" align="left"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1"><b><u>Mot de passe oublié ...</u></b></font></td>

<tr>
	<td height="50"></td>
    <td align="left"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Entrez votre login, et cliquez sur "envoyer" pour recevoir votre mot de passe par e-mail :</font></td>
	<td></td>
</tr>
...
<tr>
			 <td></td> 
     		 <td align="center"><font color="#33662B" face="Arial, Helvetica, sans-serif" size="-1">Tapez votre login :</font>
